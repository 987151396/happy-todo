 ...
 * @Contact：
 */
public class CircleBitmap implements Transformation<Bitmap> {
    ...
    public CircleBitmap(Context context, float radius) {
...
//        }
        ...
        //右边不为圆角
        canvas.drawRect(canvas.getWidth() - radius, 0, canvas.getWidth(), canvas.getHeight(), paint);
