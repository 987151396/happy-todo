...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (TextUtils.isEmpty(textCollapse)) {
            textCollapse = getContext().getString(R.string.home_pick_up);
        }
        if (TextUtils.isEmpty(textExpand)) {
            textExpand = getContext().getString(R.string.home_hotel_detail_more);
        }
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, getResources().getColor(R.color.black_484848));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, SizeUtil.sp2px(14));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.theme_color));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, SizeUtil.sp2px(14));
    ...
    private void findViews() {
        ...
        inflater.inflate(R.layout.hotel_item_expand_collapse, this);
...
//            mTvContent.setMaxLines(mMaxCollapsedLines);
    ...
    private void setDrawbleAndText() {
        mTvExpandCollapse.setText(mCollapsed ? getResources().getString(R.string.home_hotel_detail_more) : getResources().getString(R.string.home_pick_up));
    }
