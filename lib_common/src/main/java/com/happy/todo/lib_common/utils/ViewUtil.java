...
public class ViewUtil {
    ...
    public static void setDrawableLeft(View view, int drawableId) {
        try {
            ...
            if (view instanceof TextView) {//button/editText 也都继承textView
                Drawable[] drawables = ((TextView) view).getCompoundDrawables();
                drawables[0] = drawableImg;
                ((TextView) view).setCompoundDrawables(drawables[0], drawables[1], drawables[2], drawables[3]); //设置左图标
            }
    ...
    public static void setDrawableRight(View view, int drawableId) {
        try {
            ...
            if (view instanceof TextView) { //button/editText 也都继承textView
                Drawable[] drawables = ((TextView) view).getCompoundDrawables();
                drawables[2] = drawableImg;
                ((TextView) view).setCompoundDrawables(drawables[0], drawables[1], drawables[2], drawables[3]); //设置右图标
            }
        } catch (Exception e) {
            Log.d("ViewUtils", e.getMessage());
        }
     ...
     * @param layout
     */
    public static void setAutoCancelErrorMsg(EditText editText, TextInputLayout layout) {
     ...
     * @param editText
     */
    public static void filterPasswordInput(EditText editText) {
