...
public class WheelView extends AbsWheelView {
	...
	private void initPaints() {
		...
		AppLogUtil.d("color", "bgColor: " + Integer.toHexString(bgColor) + ", (0x28000000 | ~bgColor): " + Integer.toHexString(0x28000000 | ~bgColor) + ", bgAlpha:" + Integer.toHexString(bgAlpha));
	}
...
//		}
	...
	private void fillSpecific(int position, int top) {
		...
		AppLogUtil.d(TAG, "fillSpecific() >>> mFirstPosition:" + mFirstPosition + ", mScrollingDegree:"+ mScrollingDegree + "， mCurrentItemIndex:" + mCurrentItemIndex);
...
//		}
	...
	private void fillUp(int pos, int nextBottom){
		...
		AppLogUtil.d(TAG, "fillUp() >>> mFirstPosition:" + mFirstPosition + ", mScrollingDegree:"+ mScrollingDegree + "， mCurrentItemIndex:" + mCurrentItemIndex);
	}
	...
	protected void fillGap(boolean down) {
		...
		AppLogUtil.d(TAG, "fillGap(" + (down ? "向上滑动" : "向下滑动") + ") "
...
//			mCamera.translate(mCameraOffsetX, 0, offsetZ + mRadius * CAMERA_LOCATION_Z);
			...
			AppLogUtil.d(TAG, "mCamera.getLocationX():"+ mCamera.getLocationX() + ", mCamera.getLocationY():" + mCamera.getLocationY());
			AppLogUtil.d(TAG, "position:" + position + ", degree:" + degree + ", offsetZ:" + offsetZ + ", mRadius:" + mRadius);
			//绕X轴翻转
