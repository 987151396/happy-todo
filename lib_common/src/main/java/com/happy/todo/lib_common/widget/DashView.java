...
public class DashView extends View {
    ...
    public DashView(Context context, AttributeSet attrs) {
        ...
        fromColor = typedArray.getColor(R.styleable.DashView_lineFromColor,  ResourceUtils.getColor(R.color.white));
        toColor = typedArray.getColor(R.styleable.DashView_lineToColor, ResourceUtils.getColor(R.color.transparent));
        isGradient = typedArray.getBoolean(R.styleable.DashView_dashViewIsGradient, false);
...
//        Log.d(CurrencyTag, "onMeasure: "+widthSize+"----"+heightSize);
//        Log.d(CurrencyTag, "dashOrientation: "+dashOrientation);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (isGradient) {
            LinearGradient backGradient = new LinearGradient(0, 0, getMeasuredWidth(), 0,
