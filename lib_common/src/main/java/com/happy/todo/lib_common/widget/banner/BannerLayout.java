package com.happy.todo.lib_common.widget.banner;
...
public class BannerLayout extends FrameLayout {
    ...
    private OnBannerItemScrollListener myOnBannerItemScrollListener;
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setSize(dp2px(12), dp2px(4));
            selectedGradientDrawable.setCornerRadius(dp2px(4)/2);
            //selectedGradientDrawable.setCornerRadii(new float[]{17,17,17,17});
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setAlpha(255/10*4);
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if(myOnBannerItemScrollListener != null)
                    myOnBannerItemScrollListener.onScrollListener(first,newState);
    ...
    public interface OnBannerItemScrollListener {
        void onScrollListener(int position,int scrollState);
    }

    public void setOnBannerItemScrollListener(OnBannerItemScrollListener onBannerItemScrollListener){
        this.myOnBannerItemScrollListener = onBannerItemScrollListener;
    }
}