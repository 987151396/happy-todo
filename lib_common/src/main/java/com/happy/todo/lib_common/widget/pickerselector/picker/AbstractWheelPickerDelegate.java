...
import com.happy.todo.lib_common.widget.pickerselector.view.AbsWheelView;
import com.happy.todo.lib_common.widget.pickerselector.view.BorderLabelTextView;
import com.happy.todo.lib_common.widget.pickerselector.view.WheelView;
    ...
    public void setAdapter(PickerAdapter pickerAdapter) {
        ...
        for (int j = 0; j < count; j++) {
            ...
            if (!TextUtils.isEmpty(label = mPickerAdapter.labelOfComponent(j))) {
                ...
                labelView.setHeight(SizeUtil.dp2px(44.7f));
