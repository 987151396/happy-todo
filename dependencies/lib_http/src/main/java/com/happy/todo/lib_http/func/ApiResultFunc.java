...
import com.happy.todo.lib_http.utils.NullStringToEmptyAdapterFactory;
...
public class ApiResultFunc<T> implements Function<ResponseBody, ApiResult<T>> {
    ...
    public ApiResultFunc(Type type) {
        gson = new GsonBuilder()
                ...
                .registerTypeAdapterFactory(new NullStringToEmptyAdapterFactory())//这里生成Gson时注册自定义处理String NULL值的TypeAdapter
                .serializeNulls()
                .create();
        this.type = type;
    }
            ...
            if (ApiResult.class.isAssignableFrom(cls)) {
                ...
                try {
                    ...
                    if (!List.class.isAssignableFrom(rawType) && clazz.equals(String.class)) {
                        ...
                        apiResult.setCode(ApiResult.CODE_SUCCESS);
