...
public class ApiException extends Exception {
    ...
    private static ApiException ex;

    public static ApiException getEx() {
        return ex;
    }

    /**可以通过dataWhenNotOk 获取到状态码不为OK但已解析成功的值,类型已被擦除，需要自己去强制转化**/
    private Object dataWhenNotOk;
    ...
    public ApiException(Throwable throwable, String code, Object data) {
        this(throwable, code);
        this.dataWhenNotOk = data;
    }
    ...
    public static ApiException handleException(Throwable e) {
        if (e instanceof HttpException) {
            ...
            return ex;
        } else if (e instanceof ApiNotOkException) {
            ApiNotOkException exception = (ApiNotOkException)e;
            return new ApiException(exception, exception.getCode(), exception.getData());
        }
        else {
    ...
    public Object getDataWhenNotOk() {
        return dataWhenNotOk;
    }
