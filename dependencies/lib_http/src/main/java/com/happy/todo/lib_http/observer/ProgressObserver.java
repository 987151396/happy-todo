...
public abstract class ProgressObserver<T> extends BaseObserver<T> implements ProgressCancelListener {
     ...
     */
    public ProgressObserver(Context context, IProgressDialog progressDialog) {
        super(context);
     ...
     */
    public ProgressObserver(Context context, IProgressDialog progressDialog, boolean isShowProgress, boolean isCancel) {
        super(context);
        this.progressDialog = progressDialog;
