...
public class RegisterHintDialog extends AlertDialog {
    ...
    public RegisterHintDialog(@NonNull Context context, int themeResId) {
    ...
    public void setOnClickEnterListener(RegisterHintDialog.onClickEnterListener onClickEnterListener) {
